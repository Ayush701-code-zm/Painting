  ...
  return (
    <section className="bg-[#fefcf8] py-[5rem] md:py-[7rem] px-[1.5rem] md:px-[4rem]">
      <div className="max-w-[72rem] mx-auto">
        <FadeInSection className="mb-[3rem]">
        ...
        <FadeInSection>
          <div className="mt-[2.5rem] pt-[2rem] border-t border-[rgba(28,27,24,0.08)] flex justify-center">
            <Link
              href="/shop"
              className="font-['Inter'] text-sm font-medium text-[rgba(28,27,24,0.6)] hover:text-[#1c1b18] transition-colors duration-200 underline underline-offset-4"
            >
              View all our works →
            </Link>
          </div>
